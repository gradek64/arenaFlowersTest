...
var submitHandler = function submitHandler(input) {
  return function (e) {
    e.preventDefault();
    ...
    fetch("./countriesData/".concat(inputValue, ".json")).then(function (result) {
      return result;
      ...
      var _response$data = response.data,
          ...
          capital = _response$data.capital;
      console.log({
        name: name,
        capital: capital
      });
      var isOnList = results.some(function (_ref) {
        var storeName = _ref.name;
      ...
      var listEntries = results.map(function (_ref2) {
        var name = _ref2.name,
            capital = _ref2.capital;
        return "<li class='entry' ><span>(country)</span> ".concat(name, " <span>(capital)</span> ").concat(capital, "</li>");
      });
      resultsList.innerHTML = listEntries;
      loadingStatus.innerHTML = '';
    }).catch(function (e) {
      loadingStatus.innerHTML = "".concat(inputValue, ".json does not exist");
      console.error(e);
    });
  };
};
...
},{"promise-polyfill/src/polyfill":6,"whatwg-fetch":8}],2:[function(require,module,exports){
...
},{"./allSettled":3,"./finally":4,"timers":7}],6:[function(require,module,exports){
...
},{"./allSettled":3,"./finally":4,"./index":5}],7:[function(require,module,exports){
